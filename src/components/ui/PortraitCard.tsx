    ...
    <div className="relative" style={{ perspective: 1000 }} ref={ref} onMouseMove={onMove} onMouseLeave={reset}>
      ...
      >
        <div className="relative aspect-[4/5] w-full">
          ...
          {/* Availability chip — always white text (sits on the photo). */}
          <div className="absolute end-3 top-3 inline-flex items-center gap-1.5 px-2 py-1 font-mono text-[11px] text-white">
            <StatusDot />
