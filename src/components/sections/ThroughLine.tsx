...
export function ThroughLine() {
  ...
  return (
    <FlowBranch>
      <Reveal>
        <h2 className="museum-2 measure text-text">
            ...
            */}
            <div className="grid gap-x-phi gap-y-1 py-6 sm:grid-cols-[11rem_1fr] sm:py-7">
              ...
              {/*
                ...
                headline figure.
              */}
              <dd className="tnum museum-2 order-1 leading-none text-accent sm:order-none sm:col-start-1 sm:row-span-2 sm:row-start-1">
                {pick(p.value, locale)}
              </dd>
