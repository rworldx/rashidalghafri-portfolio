 ...
 * content owns the viewport; once the page scrolls it materialises into a glass
 * bar with a bright top hairline, so content passes *under* a real layer
 * instead of meeting a permanent 1px divider.
 *
